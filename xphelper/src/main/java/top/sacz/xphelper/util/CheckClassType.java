...
public class CheckClassType {
     ...
     */
    public static boolean checkType(Class<?> methodParamClz, Class<?> convert, boolean matchParentClass) {
        ...
        return matchParentClass && (convert.isAssignableFrom(methodParamClz) || methodParamClz.isAssignableFrom(convert));
    }
